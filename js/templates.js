...
App.Templates.html = {
    GROUP_1: {
        tpl_1: ['<div>~!:CONTENT~!</div>'],
        tpl_1: ['<div>~!:MESSAGE~!</div>']
    },
    GROUP_2: {
        tpl_1: ['<div>~!:VARIABLE~!</div>']
    }
}
...
var Templator = function() {
    var init = function() {
        fb.info('Templator initialisation and parsing started');
        Templator.splitThemAll();
        Templator.freezeTplIndexes();
        fb.info('Templator initialisation and parsing finished');
    };
